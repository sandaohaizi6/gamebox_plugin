...
import 'package:gamebox_plugin/request/interceptor/storage.dart';
...
class HistoryService extends GetxService {
  ...
  Future<HistoryService> init() async {
    List<Map<String, dynamic>> hisData =
        List.from(SpUtils().getJSON("history") ?? []);
