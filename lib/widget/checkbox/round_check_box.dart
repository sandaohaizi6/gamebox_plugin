...
class RRoundCheckBox extends StatefulWidget {
  const RRoundCheckBox({
    Key? key,
    this.isChecked,
    this.checkedWidget,
  ...
  @override
  _RRoundCheckBoxState createState() => _RRoundCheckBoxState();
}

class _RRoundCheckBoxState extends State<RRoundCheckBox> {
  bool? isChecked;
  ...
  @override
  void didUpdateWidget(RRoundCheckBox oldWidget) {
    uncheckedColor =
