...
class AdvancedSearchNewForGrid extends StatefulWidget {
  ...
  dynamic keyboardIsShow;

  TextEditingController textEditingController = TextEditingController();

  AdvancedSearchNewForGrid({
    required this.data,
  ...
  @override
  _AdvancedSearchNewForGridState createState() =>
      _AdvancedSearchNewForGridState();
}

class _AdvancedSearchNewForGridState extends State<AdvancedSearchNewForGrid>
  ...
  void didChangeMetrics() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      setState(() {
        if (MediaQuery.of(navigatorKey.currentState!.context)
                .viewInsets
                .bottom ==
            0) {
          /// 键盘收回
          // print("键盘收回");
          widget.keyboardIsShow(0);
        } else {
          /// 键盘弹出
          widget.keyboardIsShow(1);
          // print("键盘弹出");
        }
      });
    });
