...
class MyPageView extends StatefulWidget {
  ...
  /// [MyPageView] will participate in accessibility scrolling more like a
  /// [ListView], where implicit scroll actions will move to the next page
  /// rather than into the contents of the [MyPageView].
  /// {@endtemplate}
  MyPageView({
    Key? key,
  ...
  ///
  /// Providing a non-null [itemCount] lets the [MyPageView] compute the maximum
  /// scroll extent.
  ///
  ...
  /// {@tool snippet}
  ///
  /// This [MyPageView] uses a custom [SliverChildBuilderDelegate] to support child
  /// reordering.
  ///
  /// ```dart
  /// class MyPageView extends StatefulWidget {
  ...
  /// A delegate that provides the children for the [MyPageView].
  ///
  /// The [PageView.custom] constructor lets you specify this delegate
  /// explicitly. The [MyPageView] and [PageView.builder] constructors create a
